    ...
    <main class="ml-20 p-8 transition-all duration-300">
        <section class="bg-white rounded-lg shadow-lg p-8 mt-8">
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-xl font-bold">Database Anggota</h1>
            </div>
            <div class="overflow-x-auto">
                <table id="anggotaTable" class="display" style="width:100%">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="border border-gray-300 px-4 py-2">Satker</th>
                            <th class="border border-gray-300 px-4 py-2">Nama Anggota</th>
                            <th class="border border-gray-300 px-4 py-2">Pangkat</th>
                            <th class="border border-gray-300 px-4 py-2">NRP</th>
                            <th class="border border-gray-300 px-4 py-2">Bidang</th>
                    ...
                    <tbody>
                        @foreach ($anggotas as $item)
                            <tr>
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_name }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_pangkat }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_nrp }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_bidang }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_contact }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_address }}</td>
                                <td class="border border-gray-300 px-4 py-2">{{ $item->anggota_jenis_kelamin }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
